...
def load_train_data():
    ...
    w_data=open('E:/tianyidata/train_list_14.txt','a')
    featureline={}
    keyfeature={}
    nm=0
...
#def yin():
    ...
    #output=open('E:/tianyidata/feature_data.pkl','wb')
...
load_train_data()
def train():
    w_data=open('E:/tianyidata/pre_1_14_y.txt','a')
    ...
    for one in feature.keys():
        ...
        for eday in range(1,8):
            for v in range(1,11):
                ...
                if precount>=0:
                    prefline.append(abs(int(precount)))
                else:
                    prefline.append(0)
        spre=str(prefline)
        spre=spre[1:-1]
